...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdHead.resident_since'
        db.delete_column(u'survey_householdhead', 'resident_since')

        # Deleting field 'HouseholdHead.time_measure'
        db.delete_column(u'survey_householdhead', 'time_measure')

        # Adding field 'HouseholdHead.resident_since_year'
        db.add_column(u'survey_householdhead', 'resident_since_year',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1984),
                      keep_default=False)

        # Adding field 'HouseholdHead.resident_since_month'
        db.add_column(u'survey_householdhead', 'resident_since_month',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=5),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HouseholdHead.resident_since'
        db.add_column(u'survey_householdhead', 'resident_since',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'HouseholdHead.time_measure'
        db.add_column(u'survey_householdhead', 'time_measure',
                      self.gf('django.db.models.fields.CharField')(default='Days', max_length=7),
                      keep_default=False)

        # Deleting field 'HouseholdHead.resident_since_year'
        db.delete_column(u'survey_householdhead', 'resident_since_year')

        # Deleting field 'HouseholdHead.resident_since_month'
        db.delete_column(u'survey_householdhead', 'resident_since_month')
