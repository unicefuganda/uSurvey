...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Women.aged_between_15_49_years'
        db.delete_column(u'survey_women', 'aged_between_15_49_years')

        # Adding field 'Women.aged_between_20_49_years'
        db.add_column(u'survey_women', 'aged_between_20_49_years',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Women.aged_between_15_49_years'
        db.add_column(u'survey_women', 'aged_between_15_49_years',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Women.aged_between_20_49_years'
        db.delete_column(u'survey_women', 'aged_between_20_49_years')
