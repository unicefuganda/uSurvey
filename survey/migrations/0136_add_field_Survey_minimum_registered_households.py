...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Survey.minimum_registered_households'
        db.add_column(u'survey_survey', 'minimum_registered_households',
                      self.gf('django.db.models.fields.IntegerField')(default=80),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Survey.minimum_registered_households'
        db.delete_column(u'survey_survey', 'minimum_registered_households')
    ...
    models = {
        ...
        'survey.audioanswer': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audioanswer'", 'null': 'True', 'to': "orm['survey.Household']"}),
            'householdmember': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audioanswer'", 'null': 'True', 'to': "orm['survey.HouseholdMember']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audioanswer'", 'null': 'True', 'to': "orm['survey.Investigator']"}),
            'is_old': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'audioanswer'", 'null': 'True', 'to': "orm['survey.Question']"}),
        ...
        'survey.enumerationarea': {
            ...
            'total_households': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'})
        },
        'survey.formula': {
        ...
        'survey.geopointanswer': {
            ...
            'answer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.ODKGeoPoint']", 'null': 'True'}),
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Batch']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'survey.imageanswer': {
            ...
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Batch']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imageanswer'", 'null': 'True', 'to': "orm['survey.Household']"}),
            'householdmember': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imageanswer'", 'null': 'True', 'to': "orm['survey.HouseholdMember']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imageanswer'", 'null': 'True', 'to': "orm['survey.Investigator']"}),
            'is_old': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'imageanswer'", 'null': 'True', 'to': "orm['survey.Question']"}),
            'rule_applied': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.AnswerRule']", 'null': 'True'})
        },
        'survey.indicator': {
        ...
        'survey.odkgeopoint': {
            'Meta': {'object_name': 'ODKGeoPoint', '_ormbases': [u'locations.Point']},
            'altitude': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'}),
            u'point_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['locations.Point']", 'unique': 'True', 'primary_key': 'True'}),
            'precision': ('django.db.models.fields.DecimalField', [], {'max_digits': '10', 'decimal_places': '3'})
        },
        ...
        'survey.survey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'minimum_registered_households': ('django.db.models.fields.IntegerField', [], {'default': '80'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
        ...
        'survey.videoanswer': {
            'Meta': {'object_name': 'VideoAnswer'},
            'answer': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.Batch']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'household': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videoanswer'", 'null': 'True', 'to': "orm['survey.Household']"}),
            'householdmember': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videoanswer'", 'null': 'True', 'to': "orm['survey.HouseholdMember']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videoanswer'", 'null': 'True', 'to': "orm['survey.Investigator']"}),
            'is_old': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'videoanswer'", 'null': 'True', 'to': "orm['survey.Question']"}),
            'rule_applied': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.AnswerRule']", 'null': 'True'})
        }
    }
