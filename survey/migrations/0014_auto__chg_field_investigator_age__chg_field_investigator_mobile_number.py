...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Investigator.age'
        db.alter_column(u'survey_investigator', 'age', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Investigator.mobile_number'
        db.alter_column(u'survey_investigator', 'mobile_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10))

    def backwards(self, orm):

        # Changing field 'Investigator.age'
        db.alter_column(u'survey_investigator', 'age', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2, null=True))

        # Changing field 'Investigator.mobile_number'
        db.alter_column(u'survey_investigator', 'mobile_number', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True))
