...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Household.random_sample_number'
        db.add_column(u'survey_household', 'random_sample_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Household.random_sample_number'
        db.delete_column(u'survey_household', 'random_sample_number')
