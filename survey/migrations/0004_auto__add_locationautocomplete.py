...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationAutoComplete'
        db.create_table(u'survey_locationautocomplete', (
        ...
        db.send_create_signal(u'survey', ['LocationAutoComplete'])


    def backwards(self, orm):
        # Deleting model 'LocationAutoComplete'
        db.delete_table(u'survey_locationautocomplete')
