...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Formula.groups'
        db.add_column(u'survey_formula', 'groups',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='as_group', null=True, to=orm['survey.HouseholdMemberGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Formula.groups'
        db.delete_column(u'survey_formula', 'groups_id')
    ...
    models = {
        ...
        'survey.formula': {
            ...
            'groups': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'as_group'", 'null': 'True', 'to': "orm['survey.HouseholdMemberGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
