...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'survey_householdhead', 'surname')
        ...
        # Deleting field 'HouseholdHead.created'
        db.delete_column(u'survey_householdhead', 'created')

        # Deleting field 'HouseholdHead.age'
        db.delete_column(u'survey_householdhead', 'age')

        # Deleting field 'HouseholdHead.modified'
        db.delete_column(u'survey_householdhead', 'modified')

        # Deleting field 'HouseholdHead.male'
        db.delete_column(u'survey_householdhead', 'male')
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'survey_householdmember', 'surname')
        ...
        db.add_column(u'survey_householdhead', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=12, null=True),
                      keep_default=False)

        # Adding field 'HouseholdHead.created'
        db.add_column(u'survey_householdhead', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdHead.age'
        db.add_column(u'survey_householdhead', 'age',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'HouseholdHead.modified'
        db.add_column(u'survey_householdhead', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'HouseholdHead.male'
        db.add_column(u'survey_householdhead', 'male',
