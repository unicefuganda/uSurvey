...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LocationTypeDetails.length_of_code'
        db.add_column(u'survey_locationtypedetails', 'length_of_code',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LocationTypeDetails.length_of_code'
        db.delete_column(u'survey_locationtypedetails', 'length_of_code')
    ...
    models = {
        ...
        'survey.locationtypedetails': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length_of_code': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
