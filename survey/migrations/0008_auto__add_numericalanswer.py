...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_numericalanswer', (
        ...
        db.send_create_signal(u'survey', ['NumericalAnswer'])


    def backwards(self, orm):
        # Deleting model 'NumericalAnswer'
        db.delete_table(u'survey_numericalanswer')
    ...
    models = {
        ...
        u'survey.numericalanswer': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'answers'", 'null': 'True', 'to': "orm['survey.Question']"})
        },
        'survey.question': {
