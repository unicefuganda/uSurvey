...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseholdMemberGroup'
        db.create_table(u'survey_householdmembergroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True, max_length=5)),
        ))
        db.send_create_signal('survey', ['HouseholdMemberGroup'])

        # Adding model 'GroupCondition'
        db.create_table(u'survey_groupcondition', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('attribute', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('condition', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal('survey', ['GroupCondition'])


    def backwards(self, orm):
        # Deleting model 'HouseholdMemberGroup'
        db.delete_table(u'survey_householdmembergroup')

        # Deleting model 'GroupCondition'
        db.delete_table(u'survey_groupcondition')
    ...
    models = {
        ...
        'survey.groupcondition': {
            ...
            'attribute': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'condition': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '20'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
