...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseholdMemberBatchCompletion'
        db.create_table(u'survey_householdmemberbatchcompletion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(related_name='completed_batches', null=True, to=orm['survey.Household'])),
            ('householdmember', self.gf('django.db.models.fields.related.ForeignKey')(related_name='completed_member_batches', null=True, to=orm['survey.HouseholdMember'])),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='completed_households', null=True, to=orm['survey.Batch'])),
            ('investigator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='completed_batches', null=True, to=orm['survey.Investigator'])),
        ))
        db.send_create_signal('survey', ['HouseholdMemberBatchCompletion'])


    def backwards(self, orm):
        # Deleting model 'HouseholdMemberBatchCompletion'
        db.delete_table(u'survey_householdmemberbatchcompletion')
    ...
    models = {
        ...
        'survey.householdbatchcompletion': {
            ...
            'householdmember': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.HouseholdMember']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
