...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AnswerRule', fields ['question']
        db.delete_unique(u'survey_answerrule', ['question_id'])


        # Changing field 'AnswerRule.question'
        db.alter_column(u'survey_answerrule', 'question_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['survey.Question']))

    def backwards(self, orm):

        # Changing field 'AnswerRule.question'
        db.alter_column(u'survey_answerrule', 'question_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['survey.Question']))
        # Adding unique constraint on 'AnswerRule', fields ['question']
        db.create_unique(u'survey_answerrule', ['question_id'])
