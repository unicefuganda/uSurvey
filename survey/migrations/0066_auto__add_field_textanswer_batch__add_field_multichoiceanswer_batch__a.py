...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TextAnswer.batch'
        db.add_column(u'survey_textanswer', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Batch'], null=True),
                      keep_default=False)

        # Adding field 'MultiChoiceAnswer.batch'
        db.add_column(u'survey_multichoiceanswer', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Batch'], null=True),
                      keep_default=False)

        # Adding field 'NumericalAnswer.batch'
        db.add_column(u'survey_numericalanswer', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Batch'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TextAnswer.batch'
        db.delete_column(u'survey_textanswer', 'batch_id')

        # Deleting field 'MultiChoiceAnswer.batch'
        db.delete_column(u'survey_multichoiceanswer', 'batch_id')

        # Deleting field 'NumericalAnswer.batch'
        db.delete_column(u'survey_numericalanswer', 'batch_id')
