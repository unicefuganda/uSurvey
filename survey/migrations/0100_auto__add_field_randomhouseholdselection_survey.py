...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomHouseHoldSelection.survey'
        db.add_column(u'survey_randomhouseholdselection', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='random_household', null=True, to=orm['survey.Survey']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomHouseHoldSelection.survey'
        db.delete_column(u'survey_randomhouseholdselection', 'survey_id')
