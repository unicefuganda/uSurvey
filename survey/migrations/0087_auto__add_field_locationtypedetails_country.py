...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationTypeDetails.country'
        db.add_column(u'survey_locationtypedetails', 'country',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='details', null=True, to=orm['locations.Location']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationTypeDetails.country'
        db.delete_column(u'survey_locationtypedetails', 'country_id')
