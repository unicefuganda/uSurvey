...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationWeight'
        db.create_table(u'survey_locationweight', (
            ...
            ('selection_probability', self.gf('django.db.models.fields.FloatField')(default=1.0)),
        ))
        db.send_create_signal('survey', ['LocationWeight'])


    def backwards(self, orm):
        # Deleting model 'LocationWeight'
        db.delete_table(u'survey_locationweight')
