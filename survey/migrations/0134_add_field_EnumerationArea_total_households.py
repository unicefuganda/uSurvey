...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnumerationArea.total_households'
        db.add_column(u'survey_enumerationarea', 'total_households',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnumerationArea.total_households'
        db.delete_column(u'survey_enumerationarea', 'total_households')
