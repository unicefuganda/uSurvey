...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Investigator.weights'
        db.alter_column(u'survey_investigator', 'weights', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Investigator.weights'
        db.alter_column(u'survey_investigator', 'weights', self.gf('django.db.models.fields.PositiveIntegerField')())
