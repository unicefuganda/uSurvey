...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseholdBatchCompletion'
        db.create_table(u'survey_householdbatchcompletion', (
        ...
        db.send_create_signal('survey', ['HouseholdBatchCompletion'])


    def backwards(self, orm):
        # Deleting model 'HouseholdBatchCompletion'
        db.delete_table(u'survey_householdbatchcompletion')
