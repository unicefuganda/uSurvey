...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigator.odk_token'
        db.add_column(u'survey_investigator', 'odk_token',
                      self.gf('django.db.models.fields.CharField')(default='12345', max_length=5),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigator.odk_token'
        db.delete_column(u'survey_investigator', 'odk_token')
