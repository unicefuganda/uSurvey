...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'survey_question', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_group', null=True, to=orm['survey.HouseholdMemberGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.group'
        db.delete_column(u'survey_question', 'group_id')
