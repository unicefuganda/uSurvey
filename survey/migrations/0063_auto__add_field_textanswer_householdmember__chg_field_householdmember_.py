...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HouseholdMember.first_name'
        db.alter_column(u'survey_householdmember', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'HouseholdMember.surname'
        db.alter_column(u'survey_householdmember', 'surname', self.gf('django.db.models.fields.CharField')(max_length=25))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HouseholdMember.first_name'
        db.alter_column(u'survey_householdmember', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'HouseholdMember.surname'
        db.alter_column(u'survey_householdmember', 'surname', self.gf('django.db.models.fields.CharField')(max_length=12))
