...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_backend', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
        ))
        db.send_create_signal(u'survey', ['Backend'])

        # Adding field 'Investigator.backend'
        db.add_column(u'survey_investigator', 'backend',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Backend'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Backend'
        db.delete_table(u'survey_backend')

        # Deleting field 'Investigator.backend'
        db.delete_column(u'survey_investigator', 'backend_id')
    ...
    models = {
        ...
        'survey.investigator': {
            ...
            'age': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'backend': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['survey.Backend']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
