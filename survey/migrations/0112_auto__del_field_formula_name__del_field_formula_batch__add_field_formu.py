...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Formula.name'
        db.delete_column(u'survey_formula', 'name')

        # Deleting field 'Formula.batch'
        db.delete_column(u'survey_formula', 'batch_id')

        # Adding field 'Formula.count'
        db.add_column(u'survey_formula', 'count',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='as_count', null=True, to=orm['survey.Question']),
                      keep_default=False)

        # Adding field 'Formula.indicator'
        db.add_column(u'survey_formula', 'indicator',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='formula', null=True, to=orm['survey.Indicator']),
                      keep_default=False)


        # Changing field 'Formula.denominator'
        db.alter_column(u'survey_formula', 'denominator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['survey.Question']))

        # Changing field 'Formula.numerator'
        db.alter_column(u'survey_formula', 'numerator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['survey.Question']))

    def backwards(self, orm):
        # Adding field 'Formula.name'
        db.add_column(u'survey_formula', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Name', max_length=50, unique=True),
                      keep_default=False)

        # Adding field 'Formula.batch'
        db.add_column(u'survey_formula', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='formula', null=True, to=orm['survey.Batch']),
                      keep_default=False)

        # Deleting field 'Formula.count'
        db.delete_column(u'survey_formula', 'count_id')

        # Deleting field 'Formula.indicator'
        db.delete_column(u'survey_formula', 'indicator_id')


        # Changing field 'Formula.denominator'
        db.alter_column(u'survey_formula', 'denominator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=100, to=orm['survey.Question']))

        # Changing field 'Formula.numerator'
        db.alter_column(u'survey_formula', 'numerator_id', self.gf('django.db.models.fields.related.ForeignKey')(default=100, to=orm['survey.Question']))
