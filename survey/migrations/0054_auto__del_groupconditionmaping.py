...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GroupConditionMaping'
        db.delete_table(u'survey_groupconditionmaping')

        # Adding M2M table for field groups on 'GroupCondition'
        db.create_table(u'survey_groupcondition_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupcondition', models.ForeignKey(orm['survey.groupcondition'], null=False)),
            ('householdmembergroup', models.ForeignKey(orm['survey.householdmembergroup'], null=False))
        ))
        db.create_unique(u'survey_groupcondition_groups', ['groupcondition_id', 'householdmembergroup_id'])


    def backwards(self, orm):
        # Adding model 'GroupConditionMaping'
        db.create_table(u'survey_groupconditionmaping', (
            ('group_condition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='household_member_groups', to=orm['survey.GroupCondition'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('household_member_group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='conditions', to=orm['survey.HouseholdMemberGroup'])),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('survey', ['GroupConditionMaping'])

        # Removing M2M table for field groups on 'GroupCondition'
        db.delete_table('survey_groupcondition_groups')
    ...
    models = {
        ...
        'survey.groupcondition': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['survey.HouseholdMemberGroup']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
