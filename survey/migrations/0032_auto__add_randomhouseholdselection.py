...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RandomHouseHoldSelection'
        db.create_table(u'survey_randomhouseholdselection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('mobile_number', self.gf('django.db.models.fields.CharField')(unique=True, max_length=10)),
            ('no_of_households', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ('selected_households', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('survey', ['RandomHouseHoldSelection'])


    def backwards(self, orm):
        # Deleting model 'RandomHouseHoldSelection'
        db.delete_table(u'survey_randomhouseholdselection')
