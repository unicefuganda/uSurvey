...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'survey_women', (
            ('aged_between_20_49_years', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('household', self.gf('django.db.models.fields.related.OneToOneField')(related_name='women', unique=True, null=True, to=orm['survey.Household'])),
