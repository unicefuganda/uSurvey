...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Batch.description'
        db.alter_column(u'survey_batch', 'description', self.gf('django.db.models.fields.CharField')(max_length=300, null=True))

    def backwards(self, orm):

        # Changing field 'Batch.description'
        db.alter_column(u'survey_batch', 'description', self.gf('django.db.models.fields.CharField')(max_length=300))
