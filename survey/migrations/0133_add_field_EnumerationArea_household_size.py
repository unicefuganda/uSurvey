...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EnumerationArea.household_size'
        db.add_column(u'survey_enumerationarea', 'household_size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EnumerationArea.household_size'
        db.delete_column(u'survey_enumerationarea', 'household_size')
    ...
    models = {
        ...
        'survey.enumerationarea': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'household_size': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
