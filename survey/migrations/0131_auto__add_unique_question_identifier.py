...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Question', fields ['identifier']
        db.create_unique(u'survey_question', ['identifier'])


    def backwards(self, orm):
        # Removing unique constraint on 'Question', fields ['identifier']
        db.delete_unique(u'survey_question', ['identifier'])
