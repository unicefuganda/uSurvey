...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_householdmember', (
            ...
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(related_name='household_member', to=orm['survey.Household'])),
        ))
        db.send_create_signal('survey', ['HouseholdMember'])


    def backwards(self, orm):
        # Deleting model 'HouseholdMember'
        db.delete_table(u'survey_householdmember')
