...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationTypeDetails'
        db.create_table(u'survey_locationtypedetails', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('required', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('has_code', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('location_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='details', to=orm['locations.LocationType'])),
        ))
        db.send_create_signal('survey', ['LocationTypeDetails'])


    def backwards(self, orm):
        # Deleting model 'LocationTypeDetails'
        db.delete_table(u'survey_locationtypedetails')
