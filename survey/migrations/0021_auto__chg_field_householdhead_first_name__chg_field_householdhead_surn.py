...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'survey_householdhead', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

        # Changing field 'HouseholdHead.surname'
        db.alter_column(u'survey_householdhead', 'surname', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
