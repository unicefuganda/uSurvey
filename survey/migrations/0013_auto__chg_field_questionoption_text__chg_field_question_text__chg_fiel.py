...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'survey_questionoption', 'text', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Question.text'
        db.alter_column(u'survey_question', 'text', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'Question.answer_type'
        db.alter_column(u'survey_question', 'answer_type', self.gf('django.db.models.fields.CharField')(max_length=15))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.text'
        db.alter_column(u'survey_question', 'text', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Question.answer_type'
        db.alter_column(u'survey_question', 'answer_type', self.gf('django.db.models.fields.CharField')(max_length=100))
