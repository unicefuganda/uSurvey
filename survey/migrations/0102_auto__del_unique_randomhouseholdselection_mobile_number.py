...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'RandomHouseHoldSelection', fields ['mobile_number']
        db.delete_unique(u'survey_randomhouseholdselection', ['mobile_number'])


    def backwards(self, orm):
        # Adding unique constraint on 'RandomHouseHoldSelection', fields ['mobile_number']
        db.create_unique(u'survey_randomhouseholdselection', ['mobile_number'])
