...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HouseholdHead.name'
        db.delete_column(u'survey_householdhead', 'name')

        # Adding field 'HouseholdHead.surname'
        db.add_column(u'survey_householdhead', 'surname',
                      self.gf('django.db.models.fields.CharField')(default='Household', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Adding field 'HouseholdHead.name'
        db.add_column(u'survey_householdhead', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Household', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'survey.household': {
            ...
            'women_20_49_years': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        'survey.householdhead': {
            ...
            'surname': ('django.db.models.fields.CharField', [], {'default': "'Household'", 'max_length': '100'})
        },
        'survey.indicator': {
