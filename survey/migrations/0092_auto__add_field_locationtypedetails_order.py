...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationTypeDetails.order'
        db.add_column(u'survey_locationtypedetails', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LocationTypeDetails.order'
        db.delete_column(u'survey_locationtypedetails', 'order')
