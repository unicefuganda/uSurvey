...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BatchLocationStatus'
        db.create_table(u'survey_batchlocationstatus', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='open_locations', null=True, to=orm['survey.Batch'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='open_batches', null=True, to=orm['locations.Location'])),
        ))
        db.send_create_signal('survey', ['BatchLocationStatus'])


    def backwards(self, orm):
        # Deleting model 'BatchLocationStatus'
        db.delete_table(u'survey_batchlocationstatus')
