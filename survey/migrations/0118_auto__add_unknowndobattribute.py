...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UnknownDOBAttribute'
        db.create_table(u'survey_unknowndobattribute', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='unknown_dob_attribute', to=orm['survey.HouseholdMember'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ))
        db.send_create_signal('survey', ['UnknownDOBAttribute'])


    def backwards(self, orm):
        # Deleting model 'UnknownDOBAttribute'
        db.delete_table(u'survey_unknowndobattribute')
