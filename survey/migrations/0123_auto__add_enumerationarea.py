...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EnumerationArea'
        db.create_table(u'survey_enumerationarea', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='enumeration_area', null=True, to=orm['survey.Survey'])),
        ))
        db.send_create_signal('survey', ['EnumerationArea'])

        # Adding M2M table for field locations on 'EnumerationArea'
        db.create_table(u'survey_enumerationarea_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('enumerationarea', models.ForeignKey(orm['survey.enumerationarea'], null=False)),
            ('location', models.ForeignKey(orm[u'locations.location'], null=False))
        ))
        db.create_unique(u'survey_enumerationarea_locations', ['enumerationarea_id', 'location_id'])


    def backwards(self, orm):
        # Deleting model 'EnumerationArea'
        db.delete_table(u'survey_enumerationarea')

        # Removing M2M table for field locations on 'EnumerationArea'
        db.delete_table('survey_enumerationarea_locations')
