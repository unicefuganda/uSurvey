...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LocationTypeDetails.code'
        db.add_column(u'survey_locationtypedetails', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


        # Changing field 'LocationTypeDetails.length_of_code'
        db.alter_column(u'survey_locationtypedetails', 'length_of_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=2, null=True))

    def backwards(self, orm):
        # Deleting field 'LocationTypeDetails.code'
        db.delete_column(u'survey_locationtypedetails', 'code')


        # Changing field 'LocationTypeDetails.length_of_code'
        db.alter_column(u'survey_locationtypedetails', 'length_of_code', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=10, null=True))
    ...
    models = {
        ...
        'survey.locationtypedetails': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length_of_code': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
