...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BatchQuestionOrder'
        db.create_table(u'survey_batchquestionorder', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='question_batch_order', to=orm['survey.Question'])),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(related_name='batch_question_order', to=orm['survey.Batch'])),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('survey', ['BatchQuestionOrder'])


    def backwards(self, orm):
        # Deleting model 'BatchQuestionOrder'
        db.delete_table(u'survey_batchquestionorder')
