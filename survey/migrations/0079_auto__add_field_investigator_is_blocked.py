...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigator.is_blocked'
        db.add_column(u'survey_investigator', 'is_blocked',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigator.is_blocked'
        db.delete_column(u'survey_investigator', 'is_blocked')
