...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionModule.description'
        db.add_column(u'survey_questionmodule', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionModule.description'
        db.delete_column(u'survey_questionmodule', 'description')
