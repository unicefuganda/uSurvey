...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Indicator.batch'
        db.add_column(u'survey_indicator', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Batch'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Indicator.batch'
        db.delete_column(u'survey_indicator', 'batch_id')
    ...
    models = {
        ...
        'survey.indicator': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'module': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['survey.QuestionModule']"}),
