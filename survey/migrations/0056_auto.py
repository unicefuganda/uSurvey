...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field conditions on 'HouseholdMemberGroup'
        db.delete_table('survey_householdmembergroup_conditions')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field conditions on 'HouseholdMemberGroup'
        db.create_table(u'survey_householdmembergroup_conditions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('householdmembergroup', models.ForeignKey(orm['survey.householdmembergroup'], null=False)),
            ('groupcondition', models.ForeignKey(orm['survey.groupcondition'], null=False))
        ))
        db.create_unique(u'survey_householdmembergroup_conditions', ['householdmembergroup_id', 'groupcondition_id'])
    ...
    models = {
        ...
        'survey.groupcondition': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'groups'", 'symmetrical': 'False', 'to': "orm['survey.HouseholdMemberGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
