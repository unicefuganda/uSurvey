...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'GroupCondition', fields ['condition']
        db.delete_unique(u'survey_groupcondition', ['condition'])

        # Removing unique constraint on 'GroupCondition', fields ['attribute']
        db.delete_unique(u'survey_groupcondition', ['attribute'])


    def backwards(self, orm):
        # Adding unique constraint on 'GroupCondition', fields ['attribute']
        db.create_unique(u'survey_groupcondition', ['attribute'])

        # Adding unique constraint on 'GroupCondition', fields ['condition']
        db.create_unique(u'survey_groupcondition', ['condition'])
