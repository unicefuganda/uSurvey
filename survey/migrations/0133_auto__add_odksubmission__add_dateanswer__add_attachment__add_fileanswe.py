...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ODKSubmission'
        db.create_table(u'survey_odksubmission', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('investigator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='odk_submissions', to=orm['survey.Investigator'])),
            ('survey', self.gf('django.db.models.fields.related.ForeignKey')(related_name='odk_submissions', to=orm['survey.Survey'])),
            ('household_member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='odk_submissions', to=orm['survey.HouseholdMember'])),
            ('form_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('instance_id', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('xml', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('survey', ['ODKSubmission'])

        # Adding model 'DateAnswer'
        db.create_table(u'survey_dateanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('investigator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dateanswer', null=True, to=orm['survey.Investigator'])),
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dateanswer', null=True, to=orm['survey.Household'])),
            ('householdmember', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dateanswer', null=True, to=orm['survey.HouseholdMember'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='dateanswer', null=True, to=orm['survey.Question'])),
            ...
            ('answer', self.gf('django.db.models.fields.DateField')(null=True)),
        ))
        db.send_create_signal('survey', ['DateAnswer'])

        # Adding model 'Attachment'
        db.create_table(u'survey_attachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['survey.ODKSubmission'])),
            ('media_file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('mimetype', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True)),
        ))
        db.send_create_signal('survey', ['Attachment'])

        # Adding model 'FileAnswer'
        db.create_table(u'survey_fileanswer', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('investigator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fileanswer', null=True, to=orm['survey.Investigator'])),
            ('household', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fileanswer', null=True, to=orm['survey.Household'])),
            ('householdmember', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fileanswer', null=True, to=orm['survey.HouseholdMember'])),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='fileanswer', null=True, to=orm['survey.Question'])),
            ('batch', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.Batch'], null=True)),
            ('rule_applied', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.AnswerRule'], null=True)),
            ('is_old', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('answer', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
        ))
        db.send_create_signal('survey', ['FileAnswer'])


    def backwards(self, orm):
        # Deleting model 'ODKSubmission'
        db.delete_table(u'survey_odksubmission')

        # Deleting model 'DateAnswer'
        db.delete_table(u'survey_dateanswer')

        # Deleting model 'Attachment'
        db.delete_table(u'survey_attachment')

        # Deleting model 'FileAnswer'
        db.delete_table(u'survey_fileanswer')
