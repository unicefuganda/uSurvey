...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnswerRule.batch'
        db.add_column(u'survey_answerrule', 'batch',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='batch_rule', null=True, to=orm['survey.Batch']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnswerRule.batch'
        db.delete_column(u'survey_answerrule', 'batch_id')
