...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'survey.groupconditionmaping': {
            'Meta': {'object_name': 'GroupConditionMaping'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'group_condition': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'household_member_groups'", 'to': "orm['survey.GroupCondition']"}),
            'household_member_group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'conditions'", 'to': "orm['survey.HouseholdMemberGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },
        'survey.household': {
        ...
        'survey.householdmembergroup': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '0', 'unique': 'True', 'max_length': '5'})
        },
        'survey.investigator': {
