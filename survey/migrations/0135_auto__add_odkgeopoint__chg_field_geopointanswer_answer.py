...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ODKGeoPoint'
        db.create_table(u'survey_odkgeopoint', (
            (u'point_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['locations.Point'], unique=True, primary_key=True)),
            ('altitude', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3)),
            ('precision', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=3)),
        ))
        db.send_create_signal('survey', ['ODKGeoPoint'])


        # Changing field 'GeopointAnswer.answer'
        db.alter_column(u'survey_geopointanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['survey.ODKGeoPoint'], null=True))

    def backwards(self, orm):
        # Deleting model 'ODKGeoPoint'
        db.delete_table(u'survey_odkgeopoint')


        # Changing field 'GeopointAnswer.answer'
        db.alter_column(u'survey_geopointanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Point'], null=True))
