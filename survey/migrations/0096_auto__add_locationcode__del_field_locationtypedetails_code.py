...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationCode'
        db.create_table(u'survey_locationcode', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(related_name='code', to=orm['locations.Location'])),
            ('code', self.gf('django.db.models.fields.CharField')(default=0, max_length=10)),
        ))
        db.send_create_signal('survey', ['LocationCode'])
    ...
    def backwards(self, orm):
        # Deleting model 'LocationCode'
        db.delete_table(u'survey_locationcode')
