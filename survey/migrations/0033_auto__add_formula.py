...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'survey_formula', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('numerator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='as_numerator', to=orm['survey.Question'])),
            ('denominator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='as_denominator', to=orm['survey.Question'])),
        ))
        db.send_create_signal('survey', ['Formula'])


    def backwards(self, orm):
        # Deleting model 'Formula'
        db.delete_table(u'survey_formula')
