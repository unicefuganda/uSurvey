...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique(u'survey_groupcondition', ['value', 'attribute', 'condition'])


    def backwards(self, orm):
        # Removing unique constraint on 'Batch', fields ['survey', 'name']
        db.delete_unique(u'survey_groupcondition', ['value', 'attribute', 'condition'])
