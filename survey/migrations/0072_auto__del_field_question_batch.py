...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field batches on 'Question'
        db.create_table(u'survey_question_batches', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm['survey.question'], null=False)),
            ('batch', models.ForeignKey(orm['survey.batch'], null=False))
        ))
        db.create_unique(u'survey_question_batches', ['question_id', 'batch_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field batches on 'Question'
        db.delete_table('survey_question_batches')
