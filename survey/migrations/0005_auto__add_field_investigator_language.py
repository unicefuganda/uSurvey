...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigator.language'
        db.add_column(u'survey_investigator', 'language',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigator.language'
        db.delete_column(u'survey_investigator', 'language')
