...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Investigator.weights'
        db.add_column(u'survey_investigator', 'weights',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Investigator.weights'
        db.delete_column(u'survey_investigator', 'weights')
    ...
    models = {
        ...
        'survey.investigator': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'weights': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
