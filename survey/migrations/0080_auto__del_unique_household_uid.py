...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Household', fields ['uid']
        db.delete_unique(u'survey_household', ['uid'])


    def backwards(self, orm):
        # Adding unique constraint on 'Household', fields ['uid']
        db.create_unique(u'survey_household', ['uid'])
