...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.module'
        db.add_column(u'survey_question', 'module',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='module', null=True, to=orm['survey.QuestionModule']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.module'
        db.delete_column(u'survey_question', 'module_id')
