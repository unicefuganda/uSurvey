...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Household.uid'
        db.alter_column(u'survey_household', 'uid', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Household.uid'
        db.alter_column(u'survey_household', 'uid', self.gf('django.db.models.fields.PositiveIntegerField')())
