...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HouseholdHead'
        db.create_table(u'survey_householdhead', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('age', self.gf('django.db.models.fields.PositiveIntegerField')(null=True)),
            ...
            ('level_of_education', self.gf('django.db.models.fields.CharField')(default='Primary', max_length=100, null=True)),
            ('resident_since', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('survey', ['HouseholdHead'])


    def backwards(self, orm):
        # Deleting model 'HouseholdHead'
        db.delete_table(u'survey_householdhead')
