...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Household.survey'
        db.add_column(u'survey_household', 'survey',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='survey_household', null=True, to=orm['survey.Survey']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Household.survey'
        db.delete_column(u'survey_household', 'survey_id')
