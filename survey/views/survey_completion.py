...
from survey.models import Survey, Interviewer, SurveyAllocation, Batch, EnumerationArea, Interview
...
def indicators_json(request):
    ...
    def get_result_json():
        ...
        for indicator in indicators:
            ...
            indicator_details[indicator.name] = indicator_df.transpose().to_dict()
