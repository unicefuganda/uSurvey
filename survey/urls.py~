...
urlpatterns = patterns('',
    ...
    url(r'^investigators/export/$', 'survey.views.investigator.download_investigators', name="download_investigators"),
    url(r'^investigators/completion_summary/(?P<investigator_id>\d+)/$', 'survey.views.investigator.show_completion_summary', name="investigator_completion_summary"),
    ...
    url(r'^ussd/simulator', permission_required('auth.can_view_investigators')(TemplateView.as_view(template_name="ussd/simulator.html")), name='simulator_page'),
    ...
    url(r'^investigators/completed/download/', 'survey.views.excel.completed_investigator', name='download_investigator_excel'),
    ...
    url(r'^surveys/investigators_completion/$', 'survey.views.survey_completion.show_investigator_completion_summary', name='show_investigator_completion_summary'),
    ...
    url(r'^questions/export/$', 'survey.views.questions.export_all_questions', name='export_all_questions'),
...
#    url(r'^odk/collect/(?P<username>\d+)/(?P<token>[^/]+)/forms$', 'survey.odk.views.form_list', name='odk_survey_forms_list'),
    ...
    url(r'^odk/collect/forms/(?P<survey_id>\d+)/(?P<household_size>\d+)?$', 'survey.odk.views.download_xform', name='download_odk_survey_form'),
