...
urlpatterns = patterns('',
                       ...
                       url(r'^success-story/$', 'survey.views.home_page.home_success_story_list',name='home_success_story_list'),
                       url(r'^success-stories/$', 'survey.views.home_page.success_story_list',
                           name='success_story_list'),
                       url(r'^success-story/new/$', 'survey.views.home_page.success_story_form',
                           name='success_story_new'),
                       url(r'^success-story/(?P<id>\d+)/$', 'survey.views.home_page.success_story_form',
                           name='success_story_edit'),
                       url(r'^success-story/delete/(?P<id>\d+)/$', 'survey.views.home_page.success_story_delete',
                       ...
                       url(r'^interviewers/(?P<interviewer_id>\d+)/(?P<mode>\w+)/$',
                           'survey.views.interviewer.edit_interviewer', name="view_interviewer_page"),
                       ...
                       url(r'^online/simulator/(?P<qset_id>\d+)/$', 'survey.online.simulator.handle_request',
                           name="test_qset_flow"),
                       url(r'^online/restart/(?P<access_id>\d+)/$', 'survey.online.online_handler.restart',
                           name="refresh_data_entry"),
                       url(r'^online/interviewer/participation/$', 'survey.online.views.respond',
                           name="online_interviewer_view"),
                       url(r'^ussd', 'survey.online.views.ussd_flow', name="ussd"),
                      ...
                      'django.contrib.auth.views.password_reset_complete'),
                       ...
                       url(r'^qset/(?P<qset_id>\d+)/assign_questions/$',
                           'survey.views.set_questions.assign', name='qset_assign_questions_page'),
                       url(r'^qset/(?P<qset_id>\d+)/update_question_orders/$',
                           'survey.views.set_questions.update_orders', name='qset_update_question_order_page'),
                       ...
                       url(r'^qsets/(?P<qset_id>\d+)/questions/$',
                           'survey.views.set_questions.index', name='qset_questions_page'),
                       ...
                       url(r'^qset/(?P<qset_id>\d+)/questions/export/$',
                           'survey.views.set_questions.export_batch_questions', name='export_questions_in_qset'),
                       ...
                       url(r'^qsets/(?P<qset_id>\d+)/questions/(?P<question_id>\d+)/add_logic/$',
                           'survey.views.set_questions.add_logic', name='add_qset_question_logic_page'),
                       url(r'^batches/questions/delete_logic/(?P<flow_id>\d+)/$',
                           'survey.views.questions.delete_logic', name='delete_question_logic_page'),
                       url(r'^qset/questions/delete_logic/(?P<flow_id>\d+)/$',
                           'survey.views.set_questions.delete_logic', name='delete_qset_question_logic_page'),
                       ...
                       url(r'^qset/batches/(?P<batch_id>\d+)/questions/sub_questions/new/$',
                           'survey.views.set_questions.new_subquestion', name='add_qset_subquestion_page'),
                       ...
                       url(r'^qset/batches/questions/(?P<question_id>\d+)/remove/$',
                           'survey.views.set_questions.remove', name='remove_qset_question_page'),
                       
                       url(r'^qset/batches/questions/(?P<loop_id>\d+)/remove_loop/$',
                           'survey.views.set_questions.remove_loop', name='remove_question_loop_page'),
                       ##########
                       url(r'^batches/$', 'survey.views.batch.list_batches'),
                       url(r'^qsets/$', 'survey.views.question_set.list_qsets', name='view_qsets'),
                       url(r'^list_questions/$', 'survey.views.question_set.list_questions', name='list_questions'),
                       url(r'^question_validators/$', 'survey.views.question_set.question_validators',
                           name='question_validators'),
                       url(r'^question_options/$', 'survey.views.question_set.question_options',
                           name='question_options'),
                       url(r'^batches/list_all_questions/$',
                           'survey.views.batch.list_all_questions', name='list_all_questions'),
                       url(r'^batches/list_batch_questions/$',
                           'survey.views.batch.list_batch_questions', name='list_batch_questions'),
                       url(r'^qset/qset_identifiers/$',
                           'survey.views.question_set.identifiers', name='qset_identifiers'),
                       url(r'^groups/$', 'survey.views.respondent_group.index',
                           name='respondent_groups_page'),
                       url(r'^groups/new/$', 'survey.views.respondent_group.add_group',
                           name='new_respondent_groups_page'),
                       url(r'^groups/(?P<group_id>\d+)/edit/$',
                           'survey.views.respondent_group.edit_group', name='respondent_groups_edit'),
                       url(r'^groups/(?P<group_id>\d+)/delete/$',
                           'survey.views.respondent_group.delete_group', name='respondent_groups_delete'),
                       # url(r'^conditions/$', 'survey.views.respondent_group.conditions',
                       #     name='show_group_condition'),
                       # url(r'^conditions/new/$', 'survey.views.respondent_group.add_condition',
                       #     name='new_group_condition'),
                       url(r'^conditions/(?P<condition_id>\d+)/delete/$',
                           'survey.views.respondent_group.delete_condition', name='delete_condition_page'),                       
                       url(r'^surveys/$', 'survey.views.surveys.index',
                           name='survey_list_page'),
                       url(r'^surveys/wipe_data/(?P<survey_id>\d+)$', 'survey.views.surveys.wipe_survey_data',
                       ...
                       url(r'^surveys/batches/$',
                           'survey.views.batch.index', name='%s_home'%Batch.resolve_tag()),
                       url(r'^surveys/batches/(?P<batch_id>\d+)/edit/$',
                           'survey.views.batch.edit', name='edit_%s_page'%Batch.resolve_tag()),
                       ...
                       url(r'^survey/(?P<survey_id>\d+)/completion/json/$',
                        ...
                        url(r'^survey/completion/json/$',
                           'survey.views.survey_completion.json_summary', name='survey_json_summary'),
                       url(r'^survey/survey_indicators/json/$',
                           'survey.views.survey_completion.indicators_json', name='survey_indicators'),
                        url(r'^survey/survey_parameters/json/$',
                           'survey.views.survey_completion.survey_parameters', name='survey_parameters'),
                       url(r'^surveys/(?P<survey_id>\d+)/batches/(?P<batch_id>\d+)/delete/$',
                           'survey.views.batch.delete', name='delete_batch'),
                       url(r'^activate_super_powers_page/$',
                           'survey.views.home_page.activate_super_powers', name='activate_super_powers_page'),
                       url(r'^deactivate_super_powers_page/$',
                           'survey.views.home_page.deactivate_super_powers', name='deactivate_super_powers_page'),
                       url(r'^surveys/(?P<survey_id>\d+)/sampling_criteria/$',
                           'survey.views.surveys.sampling_criteria', name='listing_criteria_page'),
                       url(r'^surveys/(?P<criterion_id>\d+)/delete_sampling_criterion/$',
                           'survey.views.surveys.delete_sampling_criterion', name='delete_listing_criterion'),
                       ...
                       url(r'^question_library/(?P<question_id>\d+)/edit/$',
                           'survey.views.question_template.edit', name='edit_%s' % QuestionTemplate.resolve_tag()),
                       ...
                       url(r'^parameter_template/$', 'survey.views.question_template.index',
                           {'model_class': ParameterTemplate}, name='show_%s' % ParameterTemplate.resolve_tag()),
                       url(r'^parameter_template/new/$', 'survey.views.question_template.add',
                           {'model_class': ParameterTemplate}, name='new_%s' % ParameterTemplate.resolve_tag()),
                       url(r'^question_library/(?P<question_id>\d+)/edit/$',
                           'survey.views.question_template.edit', name='edit_%s' % ParameterTemplate.resolve_tag()),
                       url(r'^parameter_template/export/$', 'survey.views.question_template.export_questions',
                           {'model_class': ParameterTemplate}, name='export_%s' % ParameterTemplate.resolve_tag()),
                       ...
                       url(r'^qset/questions/(?P<qset_id>\d+)/new/$',
                           'survey.views.set_questions.new', name='new_qset_question_page'),
                       url(r'^qset/questions/(?P<prev_quest_id>\d+)/insert/$',
                           'survey.views.set_questions.insert', name='insert_qset_question_page'),
                       url(r'^qset/questions/(?P<question_id>\d+)/loop/$',
                           'survey.views.set_questions.manage_loop', name='loop_qset_question_page'),
                       url(r'^question_set/(?P<qset_id>\d+)/questions/$',
                           'survey.views.questions.index', name='set_questions_index_page'),
                       url(r'^qset/view_data/(?P<qset_id>\d+)/$',
                           'survey.views.question_set.view_data',
                           name='view_data_home'),
                       url(r'^qset/view_listing_data/$',
                           'survey.views.question_set.view_listing_data',
                           name='view_listing_data'),
                       url(r'^qset/view_batch_data/$',
                       ...
                       url(r'^qset/download_data/(?P<qset_id>\d+)/$',
                           'survey.views.question_set.download_data',
                           name='download_qset_data'),
                       url(r'^qset/download_attachment/(?P<question_id>\d+/)/(?P<interview_id>\d+/)$',
                       ...
                       url(r'^listing_form/sampling_criteria/(?P<id>\d+)/$',
                           'survey.views.survey_listing.index',
                           name='sampling_criteria'),
                       url(r'^questions/(?P<question_id>\d+)/edit/$',
                           'survey.views.questions.edit', name='edit_question_page'),
                       url(r'^set_questions/(?P<question_id>\d+)/edit/$',
                           'survey.views.set_questions.edit', name='qset_edit_question_page'),
                       ...
                       url(r'^indicators/validate/formulae$', 'survey.views.indicators.validate_formulae',
                           name='validate_formulae'),
                       url(r'^indicators/$', 'survey.views.indicators.index',
                           name='list_indicator_page'),
                       url(r'^indicators/variables/$',
                           'survey.views.indicators.variables', name='indicator_variables'),
                       url(r'^indicators/(?P<indicator_id>\d+)/formula/new/$',
                           'survey.views.indicators.indicator_formula', name='add_formula_page'),
                       url(r'^indicators/(?P<indicator_id>\d+)/variables$',
                           'survey.views.indicators.view_indicator_variables', name='view_indicator_variables'),
                       url(r'^indicators/(?P<indicator_id>\d+)/variables/new$',
                           'survey.views.indicators.add_indicator_variable', name='add_indicator_variable'),
                       url(r'^indicators/variables/new$',
                           'survey.views.indicators.add_variable', name='add_variable'),
                       url(r'^indicators/(?P<indicator_criteria_id>\d+)/variable_condition/delete$',
                           'survey.views.indicators.delete_indicator_criteria', name='delete_indicator_criteria'),
                       url(r'^indicators/(?P<variable_id>\d+)/variable/delete$',
                           'survey.views.indicators.delete_indicator_variable', name='delete_indicator_variable'),
                       url(r'^indicators/variable/delete$',
                           'survey.views.indicators.ajax_delete_indicator_variable',
                           name='ajax_delete_indicator_variable'),
                       url(r'^indicators/(?P<indicator_id>\d+)/download_analysis$',
                           'survey.views.indicators.download_indicator_analysis',
                           name='download_indicator_analysis'),
                       url(r'^indicators/(?P<variable_id>\d+)/variables/edit$',
                           'survey.views.indicators.edit_indicator_variable', name='edit_indicator_variable'),
                       url(r'^indicators/variables/edit$',
                           'survey.views.indicators.ajax_edit_indicator_variable', name='ajax_edit_indicator_variable'),
                       url(r'^indicators/(?P<indicator_id>\d+)/simple/$',
                           'survey.views.indicators.simple_indicator', name='simple_indicator_chart_page'),
                       ...
                       url(r'^odk/collect/forms/interviews/(?P<submission_id>\d+)/$',
                           'survey.odk.views.download_odk_submissions', name='download_odk_submission'),
                       url(r'^odk/collect/forms/instances$',
                           'survey.odk.views.instances_form_list', name='instances_form_list'),
                       url(r'^odk/collect/(?P<username>\d+)/(?P<token>[^/]+)/forms$',
                           'survey.odk.views.form_list', name='odk_survey_forms_list'),
                       url(r'^odk/collect/forms/(?P<batch_id>\d+)$',
                           'survey.odk.views.download_xform', name='download_odk_batch_form'),
                       url(r'^odk/collect/forms$', 'survey.odk.views.form_list',
                           name='odk_survey_forms_list'),
                       url(r'^odk/collect/forms/listing_form$',
                           'survey.odk.views.download_listing_xform', name='download_odk_listing_form'),
