...
urlpatterns = patterns('',
                       ...
                       url(r'^listing_template/$',
                           QuestionSetView(ListingTemplate).index,
                           name='%s_home'%ListingTemplate.resolve_tag()),
                       url(r'^listing_template/new/$',
                           QuestionSetView(ListingTemplate).new,
                           name='new_%s_page'%ListingTemplate.resolve_tag()),
                       url(r'^listing_template/edit/(?P<id>\d+)/$',
                           QuestionSetView(ListingTemplate).edit,
                           name='edit_%s_page'%ListingTemplate.resolve_tag()),
                       url(r'^listing_template/delete/(?P<id>\d+)/$',
                           QuestionSetView(ListingTemplate).delete,
                           name='delete_%s'%ListingTemplate.resolve_tag()),
                       # url(r'^listing_template/qset/(?P<qset_id>\d+)/$',
                       #     QuestionSetView(ListingTemplate).assign, name='listing_assign_page'),
                       url(r'^listing_template/sampling_criteria/(?P<id>\d+)/$',
                           QuestionSetView(ListingTemplate).delete,
