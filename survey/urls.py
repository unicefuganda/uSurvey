...
urlpatterns = patterns('',
    ...
    url(r'^batches/(?P<batch_id>\d+)/non_response/activate/$', 'survey.views.batch.activate_non_response'),
    url(r'^batches/(?P<batch_id>\d+)/non_response/deactivate/$', 'survey.views.batch.deactivate_non_response'),
