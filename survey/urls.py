...
urlpatterns = patterns('',
    ...
    url(r'^odk/collect/(?P<username>\d+)/forms/$', 'survey.odk.views.form_list', name='odk_survey_forms_list'),
    url(r'^odk/collect/(?P<username>\d+)/forms/(?P<household_id>\d+)/$', 'survey.odk.views.download_xform', name='download_odk_survey_form'),
	url(r'^odk/collect/(?P<username>\d+)/forms/submission$', 'survey.odk.views.submission', name='odk_submit_forms'),
