...
#     url(r'^locations/hierarchy/add/$', 'survey.views.location_hierarchy.add', name='add_location_hierarchy'),
    ...
    url(r'^locations/weights/error_logs/$', 'survey.views.location_weights.error_logs', name='weights_error_logs_page'),
    url(r'^locations/(?P<location_id>\d+)/children', 'survey.views.locations.children', name='get_location_children'),
    url(r'^locations/(?P<location_id>\d+)/enumeration_areas', 'survey.views.locations.enumeration_areas', name='get_enumeration_areas'),
    url(r'^interviewers/$', 'survey.views.interviewer.list_interviewers', name="interviewers_page"),
    url(r'^interviewers/export/$', 'survey.views.interviewer.download_interviewers', name="download_interviewers"),
    url(r'^interviewers/completion_summary/(?P<interviewer_id>\d+)/$', 'survey.views.interviewer.show_completion_summary', name="interviewer_completion_summary"),
    url(r'^interviewers/new/$', 'survey.views.interviewer.new_interviewer', name="new_interviewer_page"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/$', 'survey.views.interviewer.show_interviewer', name="show_interviewer_page"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/block/$', 'survey.views.interviewer.block_interviewer', name="block_interviewer_page"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/block_odk/$', 'survey.views.interviewer.block_odk', name="block_interviewer_odk"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/block_ussd/$', 'survey.views.interviewer.unblock_ussd', name="block_interviewer_ussd"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/unblock_odk/$', 'survey.views.interviewer.unblock_odk', name="unblock_interviewer_odk"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/unblock_ussd/$', 'survey.views.interviewer.block_ussd', name="unblock_interviewer_ussd"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/unblock/$', 'survey.views.interviewer.unblock_interviewer', name="unblock_interviewer_page"),
    url(r'^interviewers/(?P<interviewer_id>\d+)/edit/$', 'survey.views.interviewer.edit_interviewer', name="edit_interviewer_page"),
    url(r'^interviewers/check_mobile_number', 'survey.views.interviewer.check_mobile_number', name="check_mobile_number"),
    url(r'^ussd/simulator', permission_required('auth.can_view_interviewers')(TemplateView.as_view(template_name="ussd/simulator.html")), name='simulator_page'),
    ...
    url(r'^households/download/$', 'survey.views.household.download_households', name="download_household"),
    url(r'^households/interviewers', 'survey.views.household.get_interviewers', name='load_interviewers'),
    ...
    url(r'^aggregates/spreadsheet_results/(?P<batch_id>\d+)/$', 'survey.views.excel.download_results', name='download_export_results'),
    url(r'^aggregates/download_spreadsheet', 'survey.views.excel.download', name='download_excel'),
    url(r'^interviewer_report/', 'survey.views.excel.interviewer_report', name='interviewer_report_page'),
    url(r'^interviewers/completed/download/', 'survey.views.excel.completed_interviewer', name='download_interviewer_excel'),
    ...
    url(r'^users/(?P<user_id>\d+)/deactivate/$', 'survey.views.users.deactivate', name='deactivate_user'),
    url(r'^users/(?P<user_id>\d+)/activate/$', 'survey.views.users.activate', name='activate_user'),
    url(r'^users/(?P<user_id>\d+)/$', 'survey.views.users.show', name='users_show_details'),
    ...
    url(r'^batches/(?P<batch_id>\d+)/submit_questions/$', 'survey.views.questions.submit', name='batch_questions_submission'),
    url(r'^batches/(?P<batch_id>\d+)/questions/export/$', 'survey.views.questions.export_batch_questions', name='export_questions_in_batch'),
    url(r'^batches/(?P<batch_id>\d+)/open_to$', 'survey.views.batch.open', name='batch_open_page'),
    url(r'^batches/(?P<batch_id>\d+)/all_locs$', 'survey.views.batch.all_locs', name='batch_all_locs'),
    url(r'^batches/(?P<batch_id>\d+)/non_response/activate/$', 'survey.views.batch.activate_non_response', name="activate_non_response_page"),
    url(r'^batches/(?P<batch_id>\d+)/non_response/deactivate/$', 'survey.views.batch.deactivate_non_response', name="deactivate_non_response_page"),
...
############
    ...
    url(r'^batches/questions/delete_logic/(?P<flow_id>\d+)/$', 'survey.views.questions.delete_logic', name='delete_question_logic_page'),
...
##########
    ...
    url(r'^surveys/(?P<survey_id>\d+)/survey_batches/$', 'survey.views.batch.batches', name='survey_batches_page'),
    ...
    url(r'^surveys/completion/', 'survey.views.survey_completion.show', name='survey_completion_rates'),
    url(r'^surveys/ea_completion/(?P<ea_id>\d+)/(?P<batch_id>\d+)', 'survey.views.survey_completion.ea_completion_summary', name='ea_completion_summary'),
     url(r'^surveys/locations_completion_summary/(?P<location_id>\d+)/(?P<batch_id>\d+)', 'survey.views.survey_completion.location_completion_summary', name='location_completion_summary'),
    url(r'^surveys/completion_summary/(?P<household_id>\d+)/(?P<batch_id>\d+)', 'survey.views.survey_completion.survey_completion_summary', name='house_completion_summary'),
    url(r'^surveys/interviewers_completion/$', 'survey.views.survey_completion.show_interviewer_completion_summary', name='show_interviewer_completion_summary'),
    ...
    url(r'^question_library/$', 'survey.views.question_template.index', name='show_question_library'),
    url(r'^question_library/new/$', 'survey.views.question_template.add', name='new_question_template'),
    url(r'^question_library/(?P<question_id>\d+)/edit/$', 'survey.views.question_template.edit', name='edit_question_template_page'),
    url(r'^question_library/(?P<question_id>\d+)/delete/$', 'survey.views.question_template.delete', name='delete_question_template_page'),
    url(r'^question_library/export/$', 'survey.views.question_template.export_questions', name='export_template_questions'),
    url(r'^question_library/json_filter/', 'survey.views.question_template.filter',name='filter_question_list'),
...
#    url(r'^questions/(?P<question_id>\d+)/sub_questions/edit/$', 'survey.views.questions.edit_subquestion', name='edit_subquestion_page'),
    ...
    url(r'^enumeration_area/(?P<ea_id>\d+)/edit/$', 'survey.views.enumeration_area.edit', name='edit_enumeration_area_page'),
    url(r'^enumeration_area/(?P<ea_id>\d+)/delete/$', 'survey.views.enumeration_area.delete', name='delete_enumeration_area'),
    url(r'^enumeration_area/$', 'survey.views.enumeration_area.index', name='enumeration_area_home'),
    url(r'^enumeration_area/filter/$', 'survey.views.enumeration_area.location_filter', name='location_filter'),
    url(r'^enumeration_area/sub_types/$', 'survey.views.enumeration_area.location_sub_types', name='location_sub_types'),
    url(r'^enumeration_area/ea_filter/$', 'survey.views.enumeration_area.enumeration_area_filter', name='enumeration_area_filter'),
    url(r'^enumeration_area/open_surveys/$', 'survey.views.enumeration_area.open_surveys', name='open_surveys_in_ea_area'),
   ...
   url(r'^odk/collect/(?P<username>\d+)/(?P<token>[^/]+)/forms$', 'survey.odk.views.form_list', name='odk_survey_forms_list'),
    url(r'^odk/collect/forms/(?P<survey_id>\d+)$', 'survey.odk.views.download_xform', name='download_odk_survey_form'),
    url(r'^odk/collect/forms$', 'survey.odk.views.form_list', name='odk_survey_forms_list'),
    url(r'^odk/collect/forms/household_list$', 'survey.odk.views.download_houselist_xform', name='download_odk_householdlist_form'),
