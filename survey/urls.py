...
urlpatterns = patterns('',
    ...
    url(r'^odk/collect/(?P<username>\d+)/(?P<token>[^/]+)/forms/(?P<household_id>\d+)$', 'survey.odk.views.download_xform', name='download_odk_survey_form'),
	url(r'^odk/collect/(?P<username>\d+)/(?P<token>[^/]+)/forms/submission$', 'survey.odk.views.submission', name='odk_submit_forms'),
	url(r'^odk/collect/submission_list/$', 'survey.odk.views.submission_list', name='odk_submission_list'),
