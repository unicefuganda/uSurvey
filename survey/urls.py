...
urlpatterns = patterns('',
    ...
    url(r'^locations/type/new/$', 'survey.views.locations.new_type', name='add_location_type_page'),
    url(r'^locations/new/$', 'survey.views.locations.new', name='add_location_page'),
    ...
    url(r'^questions/(?P<question_id>\d+)/delete_logic/(?P<answer_rule_id>\d+)/$', 'survey.views.questions.delete_logic', name='delete_question_logic_page'),
