...
question_2 = Question.objects.create(batch=batch, text="Have you ever heard of an illness called AIDS?", answer_type=Question.MULTICHOICE, order=1)
...
question_3 = Question.objects.create(batch=batch, text="Do you know of a place where people can go to get tested for the AIDS virus?", answer_type=Question.MULTICHOICE, order=1)
...
question_4 = Question.objects.create(batch=batch, text="Have you ever been tested to see if you have the AIDS virus?", answer_type=Question.MULTICHOICE, order=1)
...
question_5 = Question.objects.create(batch=batch, text="When was the most recent time you were tested?", answer_type=Question.MULTICHOICE, order=1)
...
question_6 = Question.objects.create(batch=batch, text="Can the virus that causes AIDS be transmitted from a mother to her baby during pregnancy?", answer_type=Question.MULTICHOICE, order=1)
...
question_7 = Question.objects.create(batch=batch, text="Can the virus that causes AIDS be transmitted from a mother to her baby during delivery?", answer_type=Question.MULTICHOICE, order=2)
...
question_8 = Question.objects.create(batch=batch, text="Can the virus that causes AIDS be transmitted from a mother to her baby by breastfeeding?", answer_type=Question.MULTICHOICE, order=3)
...
question_9 = Question.objects.create(batch=batch, text="How often do you read a newspaper or magazine?", answer_type=Question.MULTICHOICE, order=1)
...
question_10 = Question.objects.create(batch=batch, text="How often do you listen to the radio?", answer_type=Question.MULTICHOICE, order=2)
...
question_11 = Question.objects.create(batch=batch, text="How often do you watch television?", answer_type=Question.MULTICHOICE, order=3)
