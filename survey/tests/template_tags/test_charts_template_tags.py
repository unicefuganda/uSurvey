...
class ChartTemplateTagsTest(TestCase):
    ...
    def test_formats_title_for_bar_chart_given_formula_and_locations(self):
        heirachical_data = {self.kampala: {'OPTION 2': 15.0, 'OPTION 1': 15.0},
                            self.mbarara: {'OPTION 2': 40.0, 'OPTION 1': 50.0}}
        series = [{'data': [15.0, 40.0], 'name': 'OPTION 2'}, {'data': [15.0, 50.0], 'name': 'OPTION 1'}]
        self.assertEqual(series, get_computational_value_by_answer(heirachical_data))