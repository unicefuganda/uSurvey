...
class TestSurveyCompletion(BaseTest):
    def setUp(self):
        ...
        self.region = LocationType.objects.create(name='Region', parent=self.country, slug='region')
        self.city = LocationType.objects.create(name='City', parent=self.region, slug='city')
        self.parish = LocationType.objects.create(name='Parish', parent=self.city, slug='parish')
        ...
        self.uganda = Location.objects.create(name='Uganda', type=self.region, parent=self.africa)
        ...
        self.bukoto = Location.objects.create(name='Kampala City', parent=self.kampala, type=self.parish)
        ...
        #                                             survey=self.survey)
        self.household_listing_1 = HouseholdListing.objects.create(ea=self.city_ea,list_registrar=self.investigator_2,initial_survey=self.survey)
        ...
        self.survey_householdlisting_1 = SurveyHouseholdListing.objects.create(listing=self.household_listing_1,survey=self.survey)
    ...
    #     locations = response.context['locations_filter'].get_widget_data()
