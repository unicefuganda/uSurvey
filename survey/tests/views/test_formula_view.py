...
constraint_message="message")
    ...
    def test_get_new(self):
        ...
        ind = Indicator.objects.create(name='Test Indicator5', description="dummy5",display_on_dashboard=True,formulae="formulae1",
                                                  question_set_id=self.qset.id, survey_id=self.survey.id)
        response = self.client.get(reverse('add_formula_page', kwargs={"indicator_id" : ind.id}))
        ...
        self.assertEquals('Formula for Indicator Test Indicator' %
