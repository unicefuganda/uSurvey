...
class HouseholdMemberViewsTest(BaseTest):
    ...
    def setUp(self):
        ...
        permission, out = Permission.objects.get_or_create(
            codename='can_view_households', content_type=auth_content)
        ...
        survey_householdlisting = SurveyHouseholdListing.objects.create(
            listing=self.household_listing, survey=survey)
    ...
    def test_new_should_have_household_member_form_in_response_context_for_get(self):
        response = self.client.post(
            '/households/%d/member/new/' % int(self.household.id))
        ...
        self.assertIsInstance(
            response.context['member_form'], HouseholdMemberForm)
    ...
    def test_should_have_the_member_information_as_values_on_the_form(self):
        ...
        self.assertEqual(member_form.instance.surname,
                         self.household_member.surname)
        self.assertEqual(member_form.instance.date_of_birth,
                         self.household_member.date_of_birth)
