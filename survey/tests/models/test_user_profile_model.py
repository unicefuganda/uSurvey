...
class UserProfileTest(TestCase):
    ...
    def test_store(self):
        ...
        user_profile = UserProfile.objects.create(user=user, mobile_number='123456789')
    ...
    def test_mobile_number_is_unique(self):
        ...
        self.failUnlessRaises(IntegrityError, UserProfile.objects.create, mobile_number = "123456789")

    def test_mobile_number_length_must_be_less_than_10(self):
        mobile_number_of_length_11="01234567891"
        self.failUnlessRaises(DatabaseError, UserProfile.objects.create, mobile_number = mobile_number_of_length_11)