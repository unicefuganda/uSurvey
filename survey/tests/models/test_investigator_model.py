...
class InvestigatorTest(TestCase):
    ...
    def test_generate_survey_households(self):
        ...
        self.assertEqual(self.household,investigator1.generate_survey_households(self.survey)[0])
...
#         self.failUnlessRaises(IntegrityError, Interviewer.objects.create, mobile_number="123456789")
#
#     def test_mobile_number_length_must_be_less_than_10(self):
#         mobile_number_of_length_11 = "01234567891"
#         self.failUnlessRaises(DatabaseError, Interviewer.objects.create, mobile_number=mobile_number_of_length_11)
#
...
#         investigator = Interviewer.objects.create(name="investigator name", mobile_number="9876543210",
...
#         self.assertIn(uganda, location_hierarchy)
    ...
    #         order += 1
    #     #Answer rule commented by Eswar as model not there
...
#         investigator = Interviewer.objects.create(name="Another investigator",
...
#         ea = EnumerationArea.objects.create(name="EA2", survey=self.survey)
#         investigator = Interviewer.objects.create(name="investigator name_1", mobile_number="9876543210", backend=self.backend, ea=ea)
...
#         self.assertIn(data, response)
    ...
    #Eswar we can remove this as members_answered as no more exsists
