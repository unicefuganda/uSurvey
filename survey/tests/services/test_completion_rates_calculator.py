...
# from survey.models import Batch, Interviewer, Question, Backend, Survey, EnumerationArea, \
#     QuestionModule, QuestionSet, ResponseValidation
...
#             name='City', slug='city', parent=self.country)
...
#             order=1, name='somebatch', survey=self.open_survey)
...
#             ea=self.ea, list_registrar=self.investigator_1, initial_survey=self.open_survey)
...
#             listing=self.household_listing, survey=self.open_survey)
