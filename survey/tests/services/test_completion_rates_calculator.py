...
class BatchCompletionRatesTest(BaseTest):
    ...
    #     completion_rate = BatchCompletionRates(self.batch)
    #     self.batch.completed_households.create(householdmember=self.member_1)
    #     self.assertEqual(50, completion_rate.percent_completed_households(self.kampala,
    #                                                                       self.open_survey))
    #     self.batch.completed_households.create(householdmember=self.member_2)
    ...
    #     completion_rate = BatchLocationCompletionRates(self.batch, self.kampala)
    #     print self.batch.survey,"++++????????????"
    #     batch_member_completion = self.member_1.batch_completed(self.batch)
    ...
    #
    #     batch_member_completion = self.member_2.batch_completed(self.batch)
    #
