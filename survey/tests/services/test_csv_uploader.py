...
class UploaderServiceTest(BaseTest):
    ...
    def test_deletes_one_month_old_error_logs_every_time_an_instance_is_created(self):
        ...
        error_now = UploadErrorLog.objects.create(filename=self.filename, error="Some errors now")
        two_months_old_error_log = UploadErrorLog.objects.create(filename=self.filename, error="Some different errors")
        ...
        two_months_old_error_log = UploadErrorLog.objects.filter(filename=self.filename, error="Some different errors")
        ...
        error_now = UploadErrorLog.objects.filter( filename=self.filename, error="Some errors now")
