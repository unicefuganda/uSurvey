...
class ChildrenForm(ModelForm):
    ...
    def clean(self):
        ...
        self.clean_attribute(below_5, " below 5 years.", for_below_5, cleaned_data)

        has_children = cleaned_data.get("has_children")
        for_has_children = [ 'aged_between_5_12_years', 'aged_between_13_17_years'] + for_below_5
        self.clean_attribute(has_children, ".", for_has_children, cleaned_data)

        self.check_total_below_5(cleaned_data, for_below_5)
